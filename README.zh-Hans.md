...
> 当前版本：0.0.2-beta.1 — 针对 NuGet `GeneralUpdate.Core 10.5.0-beta.6`
...
> ⚠️ **API 说明**：v10.5.0-beta.6 采用 `UpdateRequest` 配置系统，支持可编程 `Option`、`IUpdateHooks` 生命周期钩子、`SetSource()` 零配置入口等新特性。详情请查看 BUGS.md。
