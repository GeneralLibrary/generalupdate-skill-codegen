...
- With Bowl: reference **both** `GeneralUpdate.Core` and `GeneralUpdate.Bowl` (v10.5.0-rc.1: Bowl is standalone, no type conflict)
- Differential: types are **embedded in Core**, no extra package needed
- Extension, Drivelution: standalone, no conflicts

## AppType (v10.5.0-rc.1 — enum)
